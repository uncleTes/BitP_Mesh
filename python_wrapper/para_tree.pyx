...
ctypedef public vector[bool] bvector
ctypedef public bitset[_N72] octantID
ctypedef public vector[Octant*] ptroctvector
ctypedef public vector[Octant*].iterator octantIterator

cdef extern from "ParaTree.hpp":
